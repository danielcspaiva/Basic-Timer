...
const progressContainer = '#dfe0dc'
const progressContainerHover = '#dcdddb'
...
export const CircularProgressCircle = styled.div`
    ...
    border-radius: 50%;
    overflow: hidden;
    // box-shadow: 0px 2px 2px rgba(255, 255, 255, .15);
    box-shadow: inset 0px 0px 5px rgba(0, 0, 0, .2);
    // box-shadow: inset 0px 5px 0px rgba(255, 255, 255, .15);
    display: flex;
    justify-content: center;
    align-items: center;
`;

export const CircularProgressBG = styled.div`
    position: absolute;
    width: 90%;
    height: 90%;
...
export const Segment1 = styled.div.attrs(({ completed }) => ({
    style: {
        transform: `rotate(270deg) skew(${completed < 25 ? completed * -90 / 25 + 90 : 0}deg)`,
    }
}))`
    position: absolute;
    top: 50%;
...
export const Segment2 = styled.div.attrs(({ completed }) => ({
    style: {
        transform: `rotate(0deg) skew(${completed < 25 ? 90 : completed < 50 ? completed * -90 / 25 + 180 : 0}deg)`,
    }
}))`
    position: absolute;
    top: 50%;
...
export const Segment3 = styled.div.attrs(({ completed }) => ({
    style: {
        transform: `rotate(90deg) skew(${completed < 50 ? 90 : completed < 75 ? completed * -90 / 25 + 90 : 0}deg)`,
    }
}))`
    position: absolute;
    top: 50%;
...
export const Segment4 = styled.div.attrs(({ completed }) => ({
    style: {
        transform: `rotate(180deg) skew(${completed < 75 ? 90 : completed < 100 ? completed * -90 / 25 + 180 : 0}deg)`,
    }
}))`
    position: absolute;
    top: 50%;
